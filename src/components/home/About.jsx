  ...
  return (
    <section id="conoceme" className="bg-white text-white">
      <div className="w-full flex flex-col lg:flex-row gap-0 overflow-hidden bg-[#EACB9E] mx-auto px-0">
        ...
        {/* Texto derecha */}
        <div className="w-full lg:w-1/2 bg-[#bg-[#EACB9E]] p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 flex items-center justify-center">
          <p className="text-sm sm:text-base md:text-lg lg:text-base xl:text-lg w-full lg:w-11/12 xl:w-4/5 2xl:w-3/4 leading-relaxed text-justify font-light text-black">
