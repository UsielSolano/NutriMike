...
const PlatesCarrousel = () => {
  ...
  // Importar todas las imágenes de la carpeta Plates usando Vite
  const platesModules = import.meta.glob('../assets/Plates/*.webp', { eager: true });

  // Convertir a array ordenado
  const plates = Object.keys(platesModules)
    .sort((a, b) => {
